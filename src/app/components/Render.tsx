...
//   return (
//     <div className="mt-12 flex flex-col items-center justify-center bg-white drop-shadow-xl rounded-xl w-[520px] h-[700px] gap-5 p-6">
//       <div>
//         <img src={data.thumbnail} alt={data.title} className="rounded-md w-full" />
//       </div>

//       <div className="text-center">
//         <h2 className="text-xl font-bold">{data.title}</h2>
//         <p className="text-gray-500">{data.channelName}</p>
//       </div>

//       <div className="flex flex-col gap-3 w-full">
//         <input
//           className="border-b-2 p-3 border-blue-500 font-normal"
//           type="text"
